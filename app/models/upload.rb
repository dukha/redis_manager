class Upload < ActiveRecord::Base
  attr_accessible :calmapps_language_id, :upload, :description #, :translation
  
  belongs_to :calmapps_languages

  validates :calmapps_language_id,  :presence=>true
  validates :calmapps_languages, :existence => true
