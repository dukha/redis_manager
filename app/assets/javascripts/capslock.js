/* This script checks if caps lock is on for all password fields.
 * @todo Modify to include name field
 * @todo Then include in login screen
 */
var capslock = {
  init: function() {
  ...
  show_warning: function(targ) {
    if (!targ.warning) {
      ...
      targ.warning.src = "images/capslockon.jpeg"; //http://farm3.static.flickr.com/2145/2067574980_3ddd405905_o_d.png";
